...
*recommended:* confident use of Linux and python3, knowledge of how to use DMR and MMDVM specific things, knowledge of how to program a HYTERA repeater with the CPS, basic network knowledge
