...
You can use [this Image](https://www.a23-wertheim.de/downloads/dmr/dmrgateway-2/file/35-dmrgateway-image-a23-06092018-zip) for Raspberry Pi (made by Peter/DG9FFM) and install the additional and required softwware you need like python3 and so on with the help of debian packet installer apt. 
